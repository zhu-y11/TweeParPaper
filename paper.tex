...
parser achieves an improvement of 2.3 in LAS over \nascomment{which
  comparison is this?} the singlely trained baseline
...
\begin{table*}[t]
	...
	\begin{tabular}{rrcc}
		\hline
		\it Pipeline & Metrics & Our & SOTA stack\\
		\hline
		Tokenization & \it F1 & 98.3 & \\		
		POS tagging &  \it Precision F1 & 93.7 & \\
		Universal dependencies & \it LAS F1 & 74.1 & \\
		\hline
	\end{tabular}
...
pipeline's performance in  Table \ref{tbl:pipline}.
We see the
importance of segmentation:  without gold segmentation, UD parsing
performance drops by more than four points. We also compare
our model with a stack of the state-of-the-art system: Stanford Tokenizer,
ARK tagger, and \citet{DBLP:journals/corr/DozatM16}'s parser. \yjcomment{tbd}
