...
Before annotation, we use simple regular expression to anonymize usernames and URLs.
...
to the original splits of {\sc Twebank v1}. Statistics of our annotations and data splits are shown
