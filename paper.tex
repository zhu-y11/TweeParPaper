...
cases. We witnessed a small number of tweets that contain mult-token words
...
\newcite{gimpel-EtAl:2011:ACL-HLT2011} [YICOMMENT: should be OCONNOR's paper? TOKENIZATION?]. In particular, Gimpel et al.~[YICOMMENT: SAME HERE] opted out of tokenizing
