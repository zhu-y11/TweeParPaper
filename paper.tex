...
\begin{table}[t]
	...
	\begin{tabular}{rccc}
		...
		\citet{dozat-qi-manning:2017:K17-3} & 82.3 & 78.3 & 1.7 \\
...
\begin{table}[t]
	...
	\begin{tabular}{rrcc}
		...
		\hline
	\end{tabular}
	\caption{Evaluating our pipeline against a state-of-the-art pipeline. \yjcomment{num will change}\label{tbl:pipline} %\yicomment{see tab5 for our tokenizer the pos tagging number is 93.6, here is 93.7, should be consistent}
	}
\end{table}
