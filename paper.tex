...
\citeposs{sanguinetti-17} and our  interpretation of headedness are the same, 
...
annotation unit is always the tweet in its entirety---which may consist of multiple sentences---not the sentence alone. %\nss{``Each tweet is annotated with a single tree, rather than being split into sentences.''?}
