...
%		\hline
	...
	\caption{POS tagger comparison on gold-standard tokens in the
          \textsc{Tweebank v2} test set.%\nss{why Precision and not Accuracy?}
          \label{tbl:pos-result}}
\end{table}
...
begin with the neural greedy stack LSTM parser introduced by \cite{ballesteros-dyer-smith:2015:EMNLP},
...
%		\newcite{dyer-EtAl:2015:ACL-IJCNLP} & 77.9 & 73.0 \\
		\hdashline
		%\citet{ballesteros-EtAl:2016:EMNLP2016} & & & \\
...
1.5 point behind the ensemble (last line of Table~\ref{tbl:parse-result}).
