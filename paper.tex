...
See \nss{section ref} for a comparison.} Our annotation includes 
...
I think it would be easier just to show v1 and v2 as separate rows. Also, a column for totals across the splits.}\label{tbl:data-stat}
}
\end{table}
