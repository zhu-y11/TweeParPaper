...
\begin{itemize}
\item We create a new annotated tweet dependency treebank ({\sc Tweebank v2}) following the UD convention.
This annotation contains 3,549 tweets.
Tokenization, part-of-speech tag, and dependencies of these tweets are annotated in this data.

\item We propose to use the transition-based neural parser \cite{ballesteros-EtAl:2016:EMNLP2016} with consideration of the speed in processing social media data.
To achieve a more accurate parser, we propose to train the parser with a distillation of an ensemble 20 parser and this achieve an improvement of 3 point LAS over the baseline.
\end{itemize}

We release our parser at.
...
\begin{table}[t]
	...
	\begin{tabular}{rc}
		...
		Stanford Postagger (re-train) & 90.37 \\
		UD pipe v1.2 & 78.7 \\
...
This figure shows that a larger $\alpha$
